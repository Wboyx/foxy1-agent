...
| فایل | نقش |
|---|---|
| `foxcoin.js` | هسته (نسخه ۱.۴.۰): محصول + مدیریت + فروشگاه + **جوایز فعالیت** |
| `foxcoin-ui.js` | رابط کاربری کاربر عادی (۱.۲.۰): جوایز زنده، **بدون بخش دعوت** |
| `foxcoin-admin.js` | **پنل مدیریت (۱.۳.۰): فاکس شاپ + دست بازتر + جوایز** |
...
```bash
node foxcoin.js selftest     # ۴۵ تست هسته (شامل جوایز)
node foxcoin-ui.js           # ۴۲ تست رابط کاربری (بدون دعوت)
node foxcoin-admin.js        # ۷۵ تست پنل مدیریت (فاکس شاپ + جوایز)
```
